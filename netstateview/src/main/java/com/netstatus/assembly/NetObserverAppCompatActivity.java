...
public class NetObserverAppCompatActivity extends AppCompatActivity implements NetworkStateView.OnRefreshListener{
...
//                        });
    ...
    private void initNetReceiver(NetworkStateView nsvStateView) {
        ...
        NetStatusReceiver netStatusReceiver = new NetStatusReceiver(NetObserverAppCompatActivity.this, mNetworkStateView);
        NetObserverAppCompatActivity.this.registerReceiver(netStatusReceiver, intentFilter);
    }
